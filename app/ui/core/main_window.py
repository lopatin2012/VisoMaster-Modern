...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.mediaPanelCheckBox = CheckBox(self.mediaLayout)
        ...
        self.facesPanelCheckBox = CheckBox(self.mediaLayout)
        ...
        self.parametersPanelCheckBox = CheckBox(self.mediaLayout)
        ...
        self.faceCompareCheckBox = CheckBox(self.mediaLayout)
        ...
        self.faceMaskCheckBox = CheckBox(self.mediaLayout)
        ...
        self.videoSeekLineEdit = LineEdit(self.mediaLayout)
        ...
        self.frameRewindButton = TransparentToolButton(self.mediaLayout)
        ...
        self.buttonMediaRecord = TransparentToolButton(self.mediaLayout)
        ...
        self.buttonMediaPlay = TransparentToolButton(self.mediaLayout)
        ...
        self.frameAdvanceButton = TransparentToolButton(self.mediaLayout)
        ...
        self.addMarkerButton = TransparentToolButton(self.mediaLayout)
        ...
        self.removeMarkerButton = TransparentToolButton(self.mediaLayout)
        ...
        self.previousMarkerButton = TransparentToolButton(self.mediaLayout)
        ...
        self.nextMarkerButton = TransparentToolButton(self.mediaLayout)
        ...
        self.viewFullScreenButton = TransparentToolButton(self.mediaLayout)
        ...
        self.findTargetFacesButton = PushButton(self.verticalWidget)
        ...
        self.clearTargetFacesButton = PushButton(self.verticalWidget)
        ...
        self.swapfacesButton = PrimaryPushButton(self.verticalWidget)
        ...
        self.editFacesButton = PrimaryPushButton(self.verticalWidget)
        ...
        self.saveImageButton = PushButton(self.facesPanelGroupBox)
        ...
        self.inputEmbeddingsSearchBox = LineEdit(self.facesPanelGroupBox)
        ...
        self.openEmbeddingButton = TransparentToolButton(self.facesPanelGroupBox)
        ...
        self.saveEmbeddingButton = TransparentToolButton(self.facesPanelGroupBox)
        ...
        self.saveEmbeddingAsButton = TransparentToolButton(self.facesPanelGroupBox)
        ...
        self.buttonTargetVideosPath = TransparentToolButton(self.groupBox_TargetVideos_Select)
        ...
        self.targetVideosSearchBox = LineEdit(self.dockWidgetContents)
        ...
        self.filterImagesCheckBox = CheckBox(self.dockWidgetContents)
        ...
        self.filterVideosCheckBox = CheckBox(self.dockWidgetContents)
        ...
        self.filterWebcamsCheckBox = CheckBox(self.dockWidgetContents)
        ...
        self.buttonInputFacesPath = TransparentToolButton(self.groupBox_InputFaces_Select)
        ...
        self.inputFacesSearchBox = LineEdit(self.dockWidgetContents)
        ...
        self.outputFolderLineEdit = LineEdit(self.settings_tab)
        ...
        self.outputFolderButton = PushButton(self.settings_tab)
        ...
        self.clearMemoryButton = PushButton(self.dockWidgetContents_2)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"VisoMaster-Modern", None))
