...
TRANSLATIONS = {
    "ru": {
        ...
        "Face Smoothing": "Сглаживание лица",
        ...
        "Seamless Blend": "Бесшовное смешивание",
        "Blue": "Синий",
        ...
        "Smoothing Amount": "Степень сглаживания",
        ...
        "Out of GPU Memory": "Недостаточно видеопамяти",
        "The GPU ran out of memory, so processing was stopped and models were unloaded. Lower the swapper resolution or disable heavy restorers/enhancers, then try again.": "Видеопамяти GPU не хватило. Обработка остановлена, модели выгружены. Уменьшите разрешение сваппера или отключите тяжёлые рестореры/улучшайзеры и попробуйте снова.",
        "Missing Files": "Отсутствуют файлы",
        "Some required files are missing:": "Не хватает обязательных файлов:",
        "Models Not Found": "Модели не найдены",
        "Check Models": "Проверить модели",
        "Presets": "Пресеты",
        "Save Current Face as Preset": "Сохранить текущее лицо как пресет",
        "Apply Preset to Current Face": "Применить пресет к текущему лицу",
        "Delete Preset": "Удалить пресет",
        "Save Preset": "Сохранить пресет",
        "Apply Preset": "Применить пресет",
        "Preset name:": "Имя пресета:",
        "Preset:": "Пресет:",
        "No target face selected": "Целевое лицо не выбрано",
        "Select a target face before saving a preset.": "Выберите целевое лицо перед сохранением пресета.",
        "Select a target face before applying a preset.": "Выберите целевое лицо перед применением пресета.",
        "No Presets": "Нет пресетов",
        "No presets saved yet.": "Пресеты ещё не сохранены.",
        "Preset Error": "Ошибка пресета",
        "Could not save the preset.": "Не удалось сохранить пресет.",
        "Could not delete the preset.": "Не удалось удалить пресет.",
        "Models Missing": "Не хватает моделей",
        "Some model files are missing. Run download_models.py to download them:": "Не хватает файлов моделей. Запустите download_models.py, чтобы скачать их:",
        "All model files are present.": "Все файлы моделей на месте.",
        "No models were found in model_assets/.\nRun download_models.py to download them.": "В папке model_assets/ не найдено моделей.\nЗапустите download_models.py, чтобы скачать их.",
        "Embeddings Saved": "Эмбеддинги сохранены",
        "Saved Embeddings to file:": "Эмбеддинги сохранены в файл:",
        "Image Saved": "Изображение сохранено",
        "Saved Current Image to file:": "Текущий кадр сохранён в файл:",
        "Load Failed": "Не удалось загрузить",
        "Could not load the workspace file:": "Не удалось загрузить файл сессии:",
        "Failed to load the selected media. See visomaster.log for details.": "Не удалось загрузить выбранные медиа. Подробности — в visomaster.log.",
        "Failed to load the selected face images. See visomaster.log for details.": "Не удалось загрузить выбранные изображения лиц. Подробности — в visomaster.log.",
        "Recording Error": "Ошибка записи",
        "Could not start ffmpeg for recording. Make sure ffmpeg is available.": "Не удалось запустить ffmpeg для записи. Убедитесь, что ffmpeg доступен.",
        "Error Reading Frame": "Ошибка чтения кадра",
        "Error reading frame": "Ошибка чтения кадра",
        "Stopped processing.": "Обработка остановлена.",
        "Cannot Open Media": "Не удалось открыть медиа",
        "Could not open the selected file:": "Не удалось открыть выбранный файл:",
        "Could not open the selected file.": "Не удалось открыть выбранный файл.",
        "Cannot Open Webcam": "Не удалось открыть веб-камеру",
        "Could not open the webcam. Check that it is connected and not in use.": "Не удалось открыть веб-камеру. Проверьте, что она подключена и не занята.",
        "Virtual Camera Error": "Ошибка виртуальной камеры",
        "Could not start the virtual camera. Make sure OBS (or another virtual camera) is installed and running.": "Не удалось запустить виртуальную камеру. Убедитесь, что установлен и запущен OBS (или другая виртуальная камера).",
